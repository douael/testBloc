...
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<span class="ajax_cart_quantity{if $cart_qties == 0} unvisible{/if}" style="text-align:center;bottom:6px;position:absolute;font-weight: initial;text-shadow: none;font-size: 10px;color: #1d1b1b;width:28px;">{$cart_qties}</span>
			...
			<!--span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if} unvisible">{l s='(empty)' mod='blockcart'}</span-->
